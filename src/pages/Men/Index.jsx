...
import MenHeroSlider from "../../components/Ui/menheroslider";
...
const MenPage = () => {
  ...
  return (
    <main className="pt-20 bg-gradient-to-b from-gray-50 via-white to-gray-100 min-h-screen">
      <MenHeroSlider />
